...
import { View, TouchableWithoutFeedback, Text, StyleSheet, TouchableOpacity, Dimensions, AsyncStorage } from 'react-native';
  ...
  render() {
    return (
      <View style={styles.container} >
        ...
        <View>
          <Video
            source={{ uri: `file://${RNFS.DocumentDirectoryPath}/${this.state.clicked['source']}` }}
