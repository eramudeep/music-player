...
import { View, Text, StyleSheet, TouchableOpacity, Dimensions, AsyncStorage, StatusBar, ImageBackground, TouchableWithoutFeedback, Image } from 'react-native';
...
export default class VideoPlayer extends Component {
  ...
  render() {
    const { width, height } = Dimensions.get("window");
    const normalHeight = width * 0.5625;
    return (
